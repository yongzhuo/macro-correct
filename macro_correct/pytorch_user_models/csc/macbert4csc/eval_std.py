...
def tet_test_dataset(path_model_dir=None):
    """   多个测试集   """
    ### 全量测试
    path_model_dir = path_model_dir or "../../../output/text_correction/espell_law_of_macbert4csc"
...
if __name__ == "__main__":
    ...
    ### 一次性全量测试
    path_model_dir = "../../../output/text_correction/espell_law_of_macbert4csc"
    tet_test_dataset(path_model_dir)
...
"""
macbert4csc
类似SoftMaskedBert4CSC, pycorrector提出的经典中文拼写纠错模型(纠错/检索一体化), 具有准确率高、并发强、领域适配迅速等特点;
以今天的视角看, 模型规模、数据规模、det/cor交互可能是提升其指标的方向;
"""
