...
from macro_correct.pytorch_user_models.csc.macbert4csc.dataset import save_json, load_json, txt_write, txt_read
...
def eval_std_list(path_tet=None, path_model_dir=None, threshold=0.5, args=None):
    ...
    ### 加载模型
    model = Macbert4CSCPredict(path_model_dir, path_model_dir)
