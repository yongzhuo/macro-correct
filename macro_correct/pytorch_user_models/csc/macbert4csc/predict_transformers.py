...
from macro_correct.pytorch_user_models.csc.mdcspell.dataset import DataSetProcessor, sent_mertic_det, sent_mertic_cor
from macro_correct.pytorch_user_models.csc.mdcspell.dataset import save_json, load_json
from macro_correct.pytorch_user_models.csc.mdcspell.graph import MDCSpell as Graph
...
if __name__ == "__main__":
    ...
    path_trained_model_dir = "../output_weights/csc_merge_9_public_of_mdcspell"
