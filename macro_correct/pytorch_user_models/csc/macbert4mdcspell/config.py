...
if platform.system().lower() == "windows":
    csc_config = {
        ...
        "task_name": "espell_law_of_macbert4mdcspell",
        ...
        # "model_save_path": "../../../output/text_correction",
        # "task_name": "sighan_std_of_macbert4mdcspell",
        ...
        "loss_det_rate": 0.15,  # det-loss的权重, 0.15/0.3
        "prompt_length": 0,  # 1, 3, 5
        "mask_rate": 0.2,  # 0.15, 0.2, 0,3
        "threshold": 0.5,
    ...
    csc_config = {
        ...
        # "path_tet": "../../../corpus/text_correction/espell/csc_espell_law.test",
        # "model_save_path": "../../../output/text_correction",
        # "task_name": "espell_law_std_of_macbert4mdcspell",
