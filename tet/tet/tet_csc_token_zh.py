...
text_list = [
    '不论戎装在身与否，他们本瑟不变，早已将个人梦想融入国家事业，将人生意义定位于谋求人民福祉 雪域高原的养路工人次军、为牺牲战友守墓三十四载的陈俊贵、带领村民奔小康的书记范振喜、践行科技强国战略的孔金珠、投身实业报国的李世江、致力志愿服务的史光柱……他们来自各行各业，却有一个共同的名字：最美退役军人。'
]

# text_list = ["入户及集中召开座谈会方式慰问在拉萨自主择业军转干部13人",
#              "命名及路径长妒限制，避免目录层级过深或单段名称过长，建议整条路径不超过20字符。",
#              ]
